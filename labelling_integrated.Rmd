...
ggsave("/icgc/dkfzlsdf/analysis/B210/Evelin/plots/last/all_types.pdf", width = 10, height = 7)
```
...
ggsave("/icgc/dkfzlsdf/analysis/B210/Evelin/plots/last/marker_predictions.pdf", width = 10, height = 7)
```
...
```{r fig.width=10, fig.height=7}
seu_full$scmap = scmapCluster_results$combined_labs
DimPlot(seu_full, reduction = "log.umap", group.by = "scmap", cells = which(seu_full$scmap != "unassigned"))
#DimPlot(seu_full, reduction = "log.umap", group.by = "scmap", cells = which(!is.na(seu_full$scmap)))
#DimPlot(seu_full, reduction = "log.umap", group.by = "scmap")

ggsave("/icgc/dkfzlsdf/analysis/B210/Evelin/plots/last/scmap_predictions.pdf", width = 10, height = 7)
```

```{r}
plot_grid(DimPlot(seu_full, reduction = "log.umap", group.by = "celltype", cells = which(!is.na(seu_full$celltype))), DimPlot(seu_full, reduction = "log.umap", group.by = "conos", cells = which(!is.na(seu_full$celltype))), DimPlot(seu_full, reduction = "integrated.umap", group.by = "celltype", cells = which(!is.na(seu_full$celltype))), ncol = 3)
```
