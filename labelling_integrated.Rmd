...
```{r fig.height=7, fig.width=10}
DimPlot(seu_full, reduction = "log.umap", group.by = "conos", cells = which(seu_full$conos %in% c("Endo (f)","Endo (m)","Endo L"))) + labs(title = "predicted fetal cells")
#ggsave("/icgc/dkfzlsdf/analysis/B210/Evelin/plots/last/fetal_cells.pdf", width = 10, height = 7)
```
