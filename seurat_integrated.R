...
seu <- RunUMAP(seu, reduction = "integrated.pca", dims = 1:nPCA, assay = "integrated", reduction.name = "integrated.umap")

seu <- FindNeighbors(seu, dims = 1:nPCA, reduction = "integrated.pca", assay = "integrated")
seu <- FindClusters(seu, verbose = FALSE)
seu$integrated.clusters = Idents(seu)
