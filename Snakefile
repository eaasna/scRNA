...
rule decidua_normalization:
	...
	shell:
		"""
		module load R/3.6.0 
		Rscript --vanilla {wildcards.dataset}/git-repo/decidua_normalization.R {wildcards.norm}
		"""
...
rule decidua_sce:
	...
	shell:
		"""
		module load R/3.6.0 
		Rscript --vanilla {wildcards.dataset}/git-repo/decidua_sce.R {wildcards.norm}
		"""		
