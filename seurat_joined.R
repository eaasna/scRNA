...
pdf("/icgc/dkfzlsdf/analysis/B210/Evelin/plots/most_variable_genes_SCT.pdf") 
...
save(seu, file = paste0("/icgc/dkfzlsdf/analysis/B210/Evelin/seurat_object/joined_SCT.RData"))
