...
```{r}
load(file = "/icgc/dkfzlsdf/analysis/B210/Evelin/seurat_object/cca_joined.RData")
```
...
```{r}
FeaturePlot(seu, reduction = "umap", features = c("MME", "FN1", "COL3A1"), pt.size = 0.2, ncol = 4)
ggsave("/icgc/dkfzlsdf/analysis/B210/Evelin/plots/stro_umap.pdf", height = 5, width = 15)
```
