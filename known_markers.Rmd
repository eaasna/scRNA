...
```{r}
FeaturePlot(seu, reduction = "umap", features = c("MME", "COL3A1"), pt.size = 0.2, ncol = 2)
ggsave("/icgc/dkfzlsdf/analysis/B210/Evelin/plots/stro_umap_2.pdf", height = 5, width = 10)
```
