...
integrated_var = c("PAEP", "CCL20", "CXCL8", "HSPA6", "MMP3", "SPP1", "MMP1", "MMP10", "IGFBP1", "G0S2" )
log_var = c("GNLY", "MMP9", "SAA2", "CXCL1", "CCL20", "IGFBP5", "SERPINB2", "S100A9", "SAA1", "MMP7")
VlnPlot(seu, features = log_var, pt.size = 0.2, ncol = 2)
```
